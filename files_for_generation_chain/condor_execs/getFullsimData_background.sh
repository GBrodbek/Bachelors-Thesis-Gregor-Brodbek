...
k4run ${WORK_DIR}/pythia.py -n $NUM_EVENTS --Dumper.Filename ${SAVE_DIR}/${TEMP_FILES}/out_temp_${ID}.hepmc --Pythia8.PythiaInterface.pythiacard ${WORK_DIR}/Zcards/Zcard_background.cmd
