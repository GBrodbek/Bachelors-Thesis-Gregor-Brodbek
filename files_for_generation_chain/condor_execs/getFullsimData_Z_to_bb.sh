...
NUM_EVENTS=1000
OUTPUT_FILENAME=Z_to_bb_${ID}.root
WORK_DIR=/work/gbrodbek/FCC_fullsim/FullSim_TauID/files_for_generation_chain
SAVE_DIR=/ceph/gbrodbek/data/background/Z_to_bb
...
k4run ${WORK_DIR}/pythia.py -n $NUM_EVENTS --Dumper.Filename ${SAVE_DIR}/${TEMP_FILES}/out_temp_${ID}.hepmc --Pythia8.PythiaInterface.pythiacard ${WORK_DIR}/Zcards/Zcard_Z_to_bb.cmd
